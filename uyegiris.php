...
<body>
  <div class="form">
      ...
      <div class="tab-content">
        <div id="signup">   
          <h1>Ücretsiz üye ol ve sen de Lumgoo'la</h1>
          ...
          <div class="top-row">
            <div class="field-wrap">
              ...
              <input type="text" name="uye_adi" required autocomplete="off" />
            </div>
            ...
            <div class="field-wrap">
              ...
              <input type="text" name="uye_soyadi" required autocomplete="off"/>
            </div>
          </div>
          ...
          <div class="field-wrap">
            ...
            <input type="email" name="uye_mail" required autocomplete="off"/>
          </div>
          ...
          <div class="field-wrap">
            ...
            <input type="password" name="uye_password" required autocomplete="off"/>
          </div>
          
          <button type="submit" name="kullaniciuyeol" class="button button-block">Başla</button>
        ...
        <div id="login">   
          ...
          <button type="submit" name="kullanicigirisyap" class="button button-block">Giriş yap</button>
