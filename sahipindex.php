...
<div class="banner">
	...
	<div class="container">	
			...
			<?php
				// kullanıcı adı burda
				$sahipsor=$db->prepare("SELECT sahip_adi FROM sahip WHERE sahip_online=:online");
				$sahipsor->execute(array(
				'online' => 1
				));
				while(($sonuc=$sahipsor -> fetch(PDO::FETCH_ASSOC))!==false)
				{
					echo $sonuc['sahip_adi'];
				}
				?>
			</a></p>
			...
			<div class="ban-pos-gridone l-grids">
				<div class="ban-pos-info l-grids">
					<figure class="effect-bubba">
							<a href="sahipgiris.php"><img src="images/6.jpg" alt=""/>
							<figcaption>
